...
static  struct sensor_t sSensorList[SENSOR_NUMBERS] = {
	{
#ifdef L8910_COMMON
		"PA12200001 Light Sensor",
		"TXC",
#elif defined(L9100_COMMON)
		"LTR559 Light Sensor",
		"Lite-On",
#else
		"GP2A Light Sensor",
...
#endif
#if __HAL_VER__ >= __SENSORS_DEVICE_API_VERSION_1_3__
		SENSOR_STRING_TYPE_PRESSURE,"",-1,SENSOR_FLAG_WAKE_UP,
#endif
		{}
	},
#endif
...
int sensors_poll_context_t::batch(int handle, int flags, int64_t period_ns, int64_t timeout)
{
	...
	PDEBUG("batch, handle: %d, flags: %d, period_ns: %lld, timeout: %lld, index: %d",
		handle, flags, (long long int)period_ns, (long long int)timeout, index);
